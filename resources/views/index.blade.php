...
<div class="contents">
<h1 class="head-title">Welcome to Bhutan's Largest Multiseller <span class="year">Marketplace</span></h1>
<p>Buy and sell everything from used cars to mobile phones and computers, or search lands to buy</p>
...
<option value="none">Tashigang</option>
<option value="none">Sarpang</option>
<option value="none">Phuntsholing</option>
